      ...
      <div className='flex flex-col gap-10 md:gap-14 md:flex-row items-center'>
        ...
        <div className='max-w-lg'>
          ...
          <p className='text-gray-600 text-base'>
            ...
            stunning visuals or unique imagery, our tool transforms your text into eye-catching
            images with just a few clicks. Imagine it, describe it, and watch it come to life instantly.
          </p>
