  ...
  return (
    ...
    <div >
        ...
        <div className='flex items-center gap-2 sm:gap-3'>
            <button onClick={() => navigate('/buy-credits')}className='flex items-center gap-2 bg-blue-100
            ...
            <p className='text-gray-600 max-sm:hidden pl-4'>Hi, Narendra</p>
        ...
        <div className='flex items-center gap-2 sm:gap-5'>
          <p onClick={() => navigate('/buy-credits')} className='cursor-pointer'>
            Pricing
            </p>
